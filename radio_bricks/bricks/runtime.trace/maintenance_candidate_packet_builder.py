...
CONCEPT = {
    ...
    "id": "runtime.trace.maintenance_candidate_packet_builder",
    "kind": "builder",
    "version": "0.1.0",
    "emoji": "🧹",
    "deterministic": True,
    ...
    "requires": [],
    "provides": ["runtime.maintenance_candidate_packet"],
    "side_effects": [],
    "ui_slots": [],
    "tags": ["runtime", "trace", "maintenance", "candidate", "scheduler"],
    "description": "Package a maintenance work candidate with idle-derived urgency, artifact staleness context, cooldown, and foreground-blocking posture.",
}


def build_maintenance_candidate_packet(
    candidate_id: str,
    session_id: str,
    priority: int,
    urgency: int,
...
def run(input_packet: dict[str, Any], context: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    value = build_maintenance_candidate_packet(
...
def receipts(value: dict[str, Any]) -> list[dict[str, Any]]:
    return [{
        "receipt_id": "maintenance-candidate-packet",
        "brick_id": CONCEPT["id"],
        "kind": "build",
        "label": "Built maintenance candidate packet.",
        "refs": [],
        "data": {
            "session_id": value.get("session_id", ""),
            "urgency": value.get("urgency", 0),
            "cooldown": value.get("cooldown", 0),
        },
    }]
