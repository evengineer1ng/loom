...
CONCEPT = {
    ...
    "id": "math.interpretation.label_score_packet_builder",
    "kind": "builder",
    "version": "0.1.0",
    "emoji": "📊",
    "deterministic": True,
    ...
    "requires": [],
    "provides": ["math.label_score_packet"],
    "side_effects": [],
    "ui_slots": [],
    "tags": ["math", "interpretation", "label", "score", "recognition"],
    "description": "Package a label score with distance, kind, threshold, concept collapse identity, variant identity, and feature evidence.",
}


def build_label_score_packet(
    label: str,
    score: float,
    distance: float,
    kind: str,
    ...
    variant_id: str,
    source_label: str,
    feature_evidence: list[dict[str, object]] | None,
) -> dict[str, Any]:
    return {
        "label": str(label),
        "score": float(score),
        ...
        "feature_evidence": list(feature_evidence or []),
    }
...
def run(input_packet: dict[str, Any], context: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    value = build_label_score_packet(
...
def receipts(value: dict[str, Any]) -> list[dict[str, Any]]:
    return [{
        "receipt_id": "label-score-packet",
        "brick_id": CONCEPT["id"],
        "kind": "build",
        "label": "Built label-score packet.",
        "refs": [],
        "data": {
