...
CONCEPT = {
    ...
    "id": "runtime.narration.twitter_social_pulse_packet_builder",
    "kind": "builder",
    "version": "0.1.0",
    "emoji": "🐦",
    "deterministic": True,
    ...
    "requires": [],
    "provides": ["runtime.twitter_social_pulse_packet"],
    "side_effects": [],
    "ui_slots": [],
    "tags": ["runtime", "narration", "twitter", "social", "pulse"],
    "description": "Package a Twitter social-pulse narration packet with live body text, reaction angle, why-now framing, key points, and host hint.",
}


def build_twitter_social_pulse_packet(
    tweet_id: str,
    title: str,
    body: str,
    angle: str,
...
def run(input_packet: dict[str, Any], context: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    value = build_twitter_social_pulse_packet(
...
def receipts(value: dict[str, Any]) -> list[dict[str, Any]]:
    return [{
        "receipt_id": "twitter-social-pulse-packet",
        "brick_id": CONCEPT["id"],
        "kind": "build",
        "label": "Built Twitter social-pulse packet.",
        "refs": [],
        "data": {
